...
* 
* 9/25/19 Created by S. Glazerman and S. Kabay -- current version only does 1 district
...
* Assign random number to each school
  set seed 12345 
...
*------------------------------------
  * Manual process (TO DO: turn this into a program that can be passed parameters that I've manually input here as locals)
	...
	keep if iddistrict==`district' *******<<<-------- This is just for testing. For now, doing this for one district.
...
*--------------------------------------------------------------
* Randomly assign clusters to treatment status witin stratum (district)  
*--------------------------------------------------------------
	local n0 = 10
	local n1 = 10
	local t1 "Educaid"
 ...
 *--------------------------------------------------------------------------
 * Report results of random assignment
 *--------------------------------------------------------------------------
